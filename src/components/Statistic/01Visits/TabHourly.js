...
class TabHourly extends React.Component {
    /**
     * @constructor
     */
    constructor(props) {
    ...
    getOptions() {
        const label = [...this.state.dataChart.map(item => item.timeframe.substr(11, 5))];
    ...
    download() {
        ...
        getCSVStatistics(
            ["Country", "Average", ...(this.state.listTopCountries.length > 0 ? this.state.dataTopCountries.filter(day => day.country === this.state.listTopCountries[0].country).map(day => day.timeframe !== null ? day.timeframe.substr(11, 5) : '') : [])],
            aData,
                                ...
                                <TableHead>
                                    <TableRow>
                                        ...
                                        {this.state.listTopCountries.length > 0 ? this.state.dataTopCountries.filter(day => day.country === this.state.listTopCountries[0].country).map(day => <TableCell
                                            key={day.timeframe}>{day.timeframe !== null ? day.timeframe.substr(11, 5) : ''}</TableCell>) : <></>}
                                    </TableRow>
                                </TableHead>
                                <TableBody>
...
export default withSnackbar(connect(mapStateToProps, null)(TabHourly));
