...
import {formatDate, getCSV} from "../utils";
...
class GoogleAnalytics extends React.Component {
    ...
    async createDailyRequestByCountry(countries, labels) {
        ...
        for (var i = 0; i < labels.length; i++) {
            ...
            allDays.push(date)
            let dailyCountries = await queryReport({...requestCountry, startDate: new Date(date), endDate: new Date(date),})
    ...
    download() {
        ...
        getCSV(["Nation", ...this.state.allDays], this.state.dateBasedCountries, "report-by-nation-and-day.csv", [[], ["", ...this.state.reportData.labels], ["", ...this.state.reportData.values]]);
