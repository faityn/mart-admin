...
import {GET_DAILY_SALES_COUNT, GET_DAILY_SALES_PRICE, GET_CATEGORIES} from "./Queries";
...
class SalesStatistics extends React.Component {
    ...
    async getData() {
        await this.props.apolloClient.httpClient
            ...
            .then((result) => {
                ...
                this.setState({
                    salesCount:result.data.getDailySalesCount
                });
        ...
        await this.props.apolloClient.httpClient
            ...
            .then((result) => {
                ...
                this.setState({
                    salesPrice:result.data.getDailySalesPrice
                });
    ...
    */
    ...
    download() {
        ...
        // console.log(this.state.salesCount);
