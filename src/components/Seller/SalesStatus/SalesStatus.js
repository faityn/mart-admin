...
import { GET_SELLER_PRODUCT_HISTORY } from "../../Settings/Seller/Queries";
...
class List extends BaseList {
    ...
    search(childrenName, childrenState) {
        this.setState({
            search: {
                paymentStatus: childrenState.search.paymentStatus
                    ? childrenState.search.paymentStatus === "true"
                        ? true
                        : false
                    : null,
                sellerName: childrenState.search.sellerName
