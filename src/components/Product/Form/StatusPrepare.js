...
class ProductStatusPrepare extends React.Component {
    constructor(props) {
        super(props);
                            ...
                            <Table className="order_table">
                                <TableBody>
                                    <TableRow style={{backgroundColor: "#f2f2f2", border: "1px solid #cccccc"}}>
                                        ...
                                        <TableCell className="text-center" width="14%"><strong>상품명</strong></TableCell>
                                        <TableCell className="text-center" width="3%"><strong>수량</strong></TableCell>
                                        <TableCell className="text-center" width="6%"><strong>배송할 마트</strong></TableCell>
...
export default withSnackbar(connect(mapStateToProps, null)(ProductStatusPrepare));
