...
class ProductStatusExchanged extends React.Component {
    constructor(props) {
        super(props);
            ...
            <React.Fragment>
                ...
                <div className="card mt-20">
                    ...
                    <Grid container spacing={3} md={12} xs={12}>
                        ...
                        <Grid item md={10} xs={12} className="align-items-center">
                            <Grid container>
                                <Grid item md={1} xs={12} className="align-items-center"><InputLabel>상태 일괄 입력</InputLabel></Grid>
                                <Grid item md={2} xs={12} className="align-items-center" style={{paddingLeft: "10px" }}>
                                    <FormControl size="small" fullWidth variant="outlined">
                                        ...
                                        <Select>
                                            ...
                                            <MenuItem value="2">상품 준비중</MenuItem>
                                            <MenuItem value="3">배송 중</MenuItem>
                                            <MenuItem value="4">배송완료</MenuItem>
                                            <MenuItem value="5">재배송</MenuItem>
                                            <MenuItem value="6">재배송 완료</MenuItem>
                                            <MenuItem value="7">취소요청</MenuItem>
                                            <MenuItem value="8">최소완료</MenuItem>
                                            <MenuItem value="9">배송보류</MenuItem>
                                            <MenuItem value="10">교환요청</MenuItem>
                                            <MenuItem value="11">교환완료</MenuItem>
                                            <MenuItem value="12">반품요청</MenuItem>
                                            <MenuItem value="13">반품완료</MenuItem>
                                            <MenuItem value="14">부분반품</MenuItem>
                                            <MenuItem value="15">환불 완료</MenuItem>
                                        </Select>
                                    </FormControl>
                                </Grid>
                                ...
                                <Grid item md={2} xs={12} className="align-items-center" style={{paddingLeft: "10px" }}>
                                    <Button
                                        ...
                                        startIcon={<DownloadIcon/>}>리스트 다운</Button>
                                </Grid>
                                <Grid item md={1} xs={12} className="align-items-center" style={{paddingLeft: "10px"}}>
                                    <FormControl size="small" fullWidth variant="outlined">
                                        <InputLabel>인쇄상태</InputLabel>
                                        <Select>
                                            <MenuItem value="1">주문내역서</MenuItem>
                                            <MenuItem value="2">주문내역서(고객용)</MenuItem>
                                        </Select>
                                    </FormControl>
                                </Grid>
                                <Grid item md={2} xs={12} className="align-items-center" style={{paddingLeft: "10px" }}>
                            ...
                            <Table className="order_table">
                                <TableBody>
                                    <TableRow style={{backgroundColor: "#f2f2f2", border: "1px solid #cccccc"}}>
                                        ...
                                        <TableCell className="text-center"><strong>배송할 마트</strong></TableCell>
                                        <TableCell className="text-center"><strong>주문자명</strong></TableCell>
                                        <TableCell className="text-center"><strong>수취인명</strong></TableCell>
                                        <TableCell className="text-center"><strong>주소</strong></TableCell>
                                        <TableCell className="text-center"><strong>수취인 휴대폰</strong></TableCell>
                                        <TableCell className="text-center"><strong>결제상태</strong></TableCell>
                                        <TableCell className="text-center"><strong>배송 메시지</strong></TableCell>
                                        <TableCell className="text-center"><strong>배송상태</strong></TableCell>
                                        <TableCell className="text-center"><strong>교환신청일(교환접수일)</strong></TableCell>
                                        <TableCell className="text-center"><strong>교환완료일시</strong></TableCell>
                                        ...
                                        <TableCell className="text-center"><strong>메모</strong></TableCell>
                                    </TableRow>
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell className="text-center">1</TableCell>
                                        <TableCell className="text-center"><InputLabel style={{color: "#ff0000"}}>모닝 마트</InputLabel></TableCell>
                                        ...
                                        <TableCell className="text-center">2021.01.30 00:00</TableCell>
                                        <TableCell className="text-center">-</TableCell>
                                        <TableCell className="text-center">30,000</TableCell>
                                        <TableCell className="text-center">0</TableCell>
                                        <TableCell className="text-center"><InputLabel style={{color: "#ff0000"}}>교환예정</InputLabel></TableCell>
                                        <TableCell className="text-center">유통기한 임박</TableCell>
                                        <TableCell className="text-center">홍길동 고객 요청</TableCell>
                                    </TableRow>
                                </TableBody>
                            </Table>
                        </Grid>
...
export default withSnackbar(connect(mapStateToProps, null)(ProductStatusExchanged));
