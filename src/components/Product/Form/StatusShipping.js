...
class ProductStatusShipping extends React.Component {
    constructor(props) {
        super(props);
            ...
            <React.Fragment>
                ...
                <div className="card mt-20">
                    ...
                    <Grid container spacing={3} md={12} xs={12}>
                        ...
                        <Grid item md={10} xs={12} className="align-items-center">
                            <Grid container>
                                {/*<Grid item md={1} xs={12} className="align-items-center"><InputLabel>선택된 리스트</InputLabel></Grid>*/}
...
export default withSnackbar(connect(mapStateToProps, null)(ProductStatusShipping));
