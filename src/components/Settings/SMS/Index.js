...
import { CircularProgress, Grid, Button, Table, TableBody, TableRow, TableCell, FormControlLabel, Select, MenuItem, FormControl, Checkbox, InputLabel, Link } from "@material-ui/core";
import SaveIcon from "@material-ui/icons/Save";
import SubjectIcon from '@material-ui/icons/Subject';
import DirectIcon from '@material-ui/icons/Link';
                    ...
                    <Grid item md={12} xs={12}>
                      <Table className="mail_table">
                        <TableBody>
                          ...
                          <TableRow>
                            ...
                            <TableCell>
                              <Grid container md={6} xs={12} className="align-items-center">
                                <Grid item md={3} xs={12} stye={{textAlign: "center"}}>
                                  <Button
                                    variant="contained"
                                    size="small"
                                    style={{backgroundColor: "#19c108", color: "#fff"}}
                                    startIcon={<SaveIcon />}>
                                    계정 설정 저장
                                  </Button>
                                </Grid>
                          ...
                          <TableRow>
                            <TableCell>90 Byte 초과시<br />메시지 전송 방법</TableCell>
                            <TableCell>
                              <Grid container md={8} xs={12} className="align-items-center">
                                <Grid item md={3} xs={12}>
                                  <FormControlLabel
                    ...
                    <SwipeableViews index={this.state.value}>
                      <div value={this.state.value} index={0} className="mt-12">
                        <Table className="order_table">
                          <TableBody>
                            <TableRow>
                              <TableCell rowSpan={2} width="20%"><strong>발송항목</strong></TableCell>
                              <TableCell rowSpan={2} width="20%"><strong>발송종류</strong></TableCell>
                              <TableCell className="text-center" colSpan={3}><strong>발송대상 및 SMS 문구설정</strong></TableCell>
                            </TableRow>
                            <TableRow>
                              <TableCell className="text-center" width="20%"><strong>회원</strong></TableCell>
                              <TableCell className="text-center" width="20%"><strong>본사 운영자</strong></TableCell>
                              <TableCell className="text-center" width="20%"><strong>공급사 운영자</strong></TableCell>
                            </TableRow>
