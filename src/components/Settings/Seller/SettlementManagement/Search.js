    ...
    if(type === "center") {
      this.setState({
        search: {
          ...
          "sellerName": this.state.search.sellerName,
          "centerWarehouse": e.target.checked,
          "insideWarehouse": this.state.search.insideWarehouse,
          "status": this.state.search.status,
          "chooseStatus": this.state.search.chooseStatus,
          "supplyPrice": this.state.search.supplyPrice,
    ...
    if(type === "inside") {
      this.setState({
        search: {
          ...
          "sellerName": this.state.search.sellerName,
          "centerWarehouse": this.state.search.centerWarehouse,
          "insideWarehouse": e.target.checked,
          "status": this.state.search.status,
          "chooseStatus": this.state.search.chooseStatus,
          "supplyPrice": this.state.search.supplyPrice,
          "sku": this.state.search.sku,
   ...
   */
   checkStatus(e) {
    ...
    if (this.state.search.chooseStatus.includes(e.target.id)) {
      newArray = newArray.filter(chooseStatus => chooseStatus !== e.target.id);
    }
            ...
            <Grid container spacing={3} alignItems="center">
              ...
              <Grid item md={4} xs={12}>
                <FormControl component="fieldset">
                  <RadioGroup aria-label="paymentStatus" name="paymentStatus"onChange={this.checkPaymentStatus.bind(this)}>
                    <FormControlLabel value="true" control={<Radio />} label="Done" checked={this.state.search.paymentStatus === "true"} />
                    <FormControlLabel value="false" control={<Radio />} label="Waiting"checked={this.state.search.paymentStatus === "false"}  />
                  </RadioGroup>
                </FormControl>
              </Grid>
              ...
              <Grid item md={4} xs={12}>
                <TextField
                  ...
                  variant="outlined"
                  name="sellerName"
                  onChange={(sellerName) => this.saveData(sellerName)}
            ...
            <Grid container spacing={3} alignItems="center">
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      id="center"
                      value={true}
                      checked={this.state.search.centerWarehouse === true}
                      onChange={(e) => this.chooseWarehouse(e, "center")}
                    />
                  }
                  label="본사 창고"
                />
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      id="inside"
                      value={true}
                      checked={this.state.search.insideWarehouse === true}
                      onChange={(e) => this.chooseWarehouse(e, "inside")}
                    />
                  }
                  label="기타 창고"
                />
              ...
              <Grid item md={4} xs={12}>
                <TextField
                  ...
                  variant="outlined"
                  name="supplyPrice"
                  onChange={(supplyPrice) => this.saveData(supplyPrice)}
                  value={this.state.search.supplyPrice}
                  m={20}
                />
              </Grid>
            </Grid>
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      checked={this.state.search.chooseStatus.findIndex(f => f === "Warehousing") !== -1}
                    />
                  }
                  label="입고"
                />
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      value="SALES"
                      onChange={this.checkStatus.bind(this)}
                      checked={this.state.search.chooseStatus.findIndex(f => f === "SALES") !== -1}
                    />
                  }
                  label="판매"
                />
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      value="MARKETING"
                      onChange={this.checkStatus.bind(this)}
                      checked={this.state.search.chooseStatus.findIndex(f => f === "MARKETING") !== -1}
                    />
                  }
                  label="마케팅"
                />
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      value="RETURN"
                      onChange={this.checkStatus.bind(this)}
                      checked={this.state.search.chooseStatus.findIndex(f => f === "RETURN") !== -1}
                    />
                  }
                  label="반품"
                />
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      value="DELETED"
                      onChange={this.checkStatus.bind(this)}
                      checked={this.state.search.chooseStatus.findIndex(f => f === "DELETED") !== -1}
                    />
                  }
                  label="폐기"
                />
            ...
            <Grid container spacing={3} alignItems="center">
              ...
              <Grid item md={5} sm={6} xs={12}>
                <TextField
                  ...
                  variant="outlined"
                  name="description"
                  onChange={(description) => this.saveData(description)}
