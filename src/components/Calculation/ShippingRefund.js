...
class ShippingRefund extends React.Component {
    constructor(props) {
        super(props);
    }
                            ...
                            <Table className="order_table">
                                <TableBody>
                                    <TableRow style={{backgroundColor: "#f2f2f2", border: "1px solid #cccccc"}}>
                                        ...
                                        <TableCell className="text-center"><strong>배송수수료</strong></TableCell>
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell className="text-center"></TableCell>
                                        <TableCell className="text-center"></TableCell>
                                        <TableCell className="text-center">무통장입금</TableCell>
                                    </TableRow>
                                </TableBody>
                            </Table>
                        </Grid>
...
export default withSnackbar(connect(mapStateToProps, null)(ShippingRefund));
